...
public class AuthService implements IAuthUseCase {
    ...
    private final UserRepositoryJpa userFullRepository;
    ...
    public Map<String, Object> authWithLDAPActiveDirectory(AuthRequestDto userRequest,
        ...
        try {
            ...
            if (isAccountValid) {
                ...
                UserEntity userFull = this.userFullRepository.findBySAMAccountName(userRequest.getSAMAccountName())
                        .get();
                ...
                userRequestDto.setCargo(userFull.getCargo());
